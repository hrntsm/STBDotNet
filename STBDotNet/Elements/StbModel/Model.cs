...
namespace STBDotNet.Elements.StbModel
{
    public class Model
    {
        ...
        [XmlArrayItem("StbDrawAxis")] public List<DrawingAxis> DrawingAxises { get; set; }
        [XmlArray("StbStories")]
        ...
        [XmlArrayItem("StbWall_RC", Type = typeof(WallRc))]
        [XmlArrayItem("StbSlab_RC", Type = typeof(SlabRc))]
        [XmlArrayItem("StbSlab_Deck", Type = typeof(SlabDeck))]
